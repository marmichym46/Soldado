...
public class ListaSoldadoHospital extends AppCompatActivity implements Response.ErrorListener, Response.Listener<JSONObject>{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lista_soldado_hospital);

        listasoldado=new ArrayList<>();
        recyclerSoldado = (RecyclerView) findViewById(R.id.RecyclerHospital);
    ...
    public void cargarservice(){
        String url="https://grupob-electiva4.000webhostapp.com/Soldado/ListaEstado/lissoldadoHospital.php";
