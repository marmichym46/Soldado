...
public class ListaSoldadoComision extends AppCompatActivity implements Response.ErrorListener, Response.Listener<JSONObject> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lista_soldado_comision);

        listasoldado=new ArrayList<>();
        recyclerSoldado = (RecyclerView) findViewById(R.id.RecyclerComision);
    ...
    public void cargarservice(){
        String url="https://grupob-electiva4.000webhostapp.com/Soldado/ListaEstado/lissoldadoComision.php";
