...
public class ListaSoldadoPresente extends AppCompatActivity implements Response.ErrorListener, Response.Listener<JSONObject>{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lista_soldado_presente);
        listasoldado=new ArrayList<>();
        recyclerSoldado = (RecyclerView) findViewById(R.id.RecyclerPresente);
    ...
    public void cargarservice(){
        String url="https://grupob-electiva4.000webhostapp.com/Soldado/ListaEstado/lissoldadoPresente.php";
